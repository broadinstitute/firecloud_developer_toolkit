...
gcloud compute instances create $instance_name --machine-type $mtype --image-family ubuntu-1604-lts --image-project ubuntu-os-cloud --disk name=$disk_name,mode=rw
